---
title: "Chapter 9: ChatGPT for Research and Learning"
description: "ChatGPT can make research and learning faster, but speed can create shallow confidence. The goal is not to collect fluent answers. The goal is to build understanding that can be…"
sidebar:
  order: 9
  label: "ChatGPT for Research and Learning"
---
