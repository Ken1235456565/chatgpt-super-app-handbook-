---
title: "Chapter 10: ChatGPT for Everyday Productivity and Scheduled Work"
description: "Everyday productivity is not about doing more busywork. It is about turning scattered inputs into clear decisions, tasks, templates, and follow-through. ChatGPT can help organize…"
sidebar:
  order: 10
  label: "ChatGPT for Everyday Productivity and Scheduled Work"
---
...
## 10.1 Turning Daily Chaos Into Clear Tasks
...
## 10.2 Planning Days, Weeks, and Projects
...
## 10.7 Scheduled Tasks and Background Work

Use recurring or delayed work for outcomes such as daily reports, weekly summaries, recurring checks, and follow-up reminders. The product concept is defined once in [Chapter 3](/chapter-03/#38-creating-recurring-work-with-scheduled); this chapter focuses on productive use.
...
Recurring work runs without a person watching every step. Apply [Chapter 13's permission and sandbox guidance](/chapter-13/#1312-permissions-sandboxes-and-cross-cutting-checks), review early runs, and define when the task should stop, report uncertainty, or ask for input.

## 10.8 Plugins for Repeated Work

Use a Plugin when repeated work depends on a consistent method or an approved external system. [Chapter 3](/chapter-03/#36-using-plugins-skills-connectors-and-apps) owns the definition of Plugins, skills, connectors, and apps.

Review integration risk and authentication using [Chapter 13](/chapter-13/#133-plugin-permissions).
...
## 10.10 Avoiding Productivity Theater
